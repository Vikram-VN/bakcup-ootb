...
import {getCurrentProductId} from '@sugar-candy-framework/commerce-utils/selector';
...
export const fetcher = store =>
  store.endpoint('getProductsPrices', {productIds: getCurrentProductId(store.getState())});
